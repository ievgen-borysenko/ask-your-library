...
- **Chapter reads are capped at 12,000 characters**, and since 2026-09-17 (#28,
  ...
  chapter — but only when the request says what it is looking for. 62% of the demo corpus's 1,245
  sections are longer than one read (median 14,804 characters, the longest 245,244), so until this

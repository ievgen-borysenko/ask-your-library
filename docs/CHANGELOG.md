...
- **Two golden items are scored by the owner's verdicts of 2026-09-19; reports made before this
  ...
  manual-correctness checkbox. `q16-refusal-casino-royale` now passes when the catalogue answers
  ...
  `836d3870` → `da92000b`. **Old runs are not re-scored automatically**: a committed report that
  shows c09 or q16 as FAIL for these reasons keeps that verdict until the run is scored again.

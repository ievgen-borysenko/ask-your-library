...
`secrets`, `dependencies`), requires the branch to be up to date with `main` before it merges, and
refuses force-pushes and deletion of the branch, with no bypass for anyone. An exception is
